...
srun python ../train_GVSNETPlus.py --num_gpus 4 --dataset_name carlaGVS --root_dir /scratch/project_2001055/dataset/GVS \
  --log_dir /scratch/project_2001055/trained_logs/GVSPlus_VAE_noSkip \
  ...
  --use_disparity_loss --use_vae --training --exp_name exp_GVSPlus_AlphaSampler_withoutSkipConnection

...
srun python ../train_GVSNETPlus.py --num_gpus 4 --dataset_name carlaGVS --root_dir /scratch/project_2001055/dataset/GVS \
  ...
  --img_wh 256 256 --noise_std 0.1 --num_epochs 60 --batch_size 4 --num_rays 8192 --N_importance 8 \
  --optimizer adam --lr 5e-3 --lr_scheduler steplr --decay_step 30 50 --decay_gamma 0.5 \
  --use_disparity_loss --use_style_loss --exp_name exp_GVSPlus_AlphaSampler_StyleLossAdaIn_withoutSkipConnection

...
srun python ../train_SUN.py --dataset_name carlaGVS --root_dir /scratch/project_2001055/dataset/GVS \
        ...
        --img_wh 256 256 --noise_std 0.1 --num_epochs 1 --batch_size 8  --num_rays 32 --N_importance 96 \
        --optimizer adam --lr 4e-5 --lr_scheduler steplr  --decay_step 2 4 8 12  --decay_gamma 0.5 \
